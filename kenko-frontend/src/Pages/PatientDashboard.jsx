        ...
        <div className='container'>
                ...
                <ul className='list-group list-group-flush'>
                  <li className='list-group-item'>
                    <div className='flex'>
                      ...
                      <p>
                        Dr. Atul Chauchan added two new conditions to your
                        health record on 09 May regarding your symptoms
                      </p>
                    </div>
                  </li>
                  <li className='list-group-item'>
          ...
          <div className='flex'>
              ...
              <div className='card me-3 my-2 shadow-md'>
                <div className='card-body'>
                  ...
                  <p className='card-text'>
                    Take 1 with food twice a day, and avoid drinking alcohol for
                    2 hours after.
                  </p>
                  <p className='text-blue-600 mt-1'>Last Refil 27 Apr, 2020</p>
                </div>
            ...
            <div className='col-4'>
              ...
              <div className='card me-3 my-2 shadow-md'>
                <div className='card-body'>
                  ...
                  <h6 className='card-subtitle mb-2 text-muted'>
                    A condition in which the cavity around the nasal passage
                    become inflamed
                  </h6>
            ...
            <div className='col-4'>
              ...
              <div class='card me-3 my-2 shadow-md'>
                <div class='card-body'>
                  <div className='flex mt-2'>
                    <div className='col-6 me-2'>
